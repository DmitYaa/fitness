...
INSERT INTO Exercise(name, muscle, description, video, image, trainer_id) VALUES ('прес от пола', 'прес', 'Классическоеупражнение на мышцы преса', 'D:\Project\fitness\backend\src\main\resources\files\pressVideo.MOV', 'D:\Project\fitness\backend\src\main\resources\files\press.jpg', 1);
INSERT INTO Exercise(name, muscle, description, video, image, trainer_id) VALUES ('классическое приседание', 'квадрицепсы', 'основа, которой нужно овладеть перед тем, как приступать к другим разновидностям этого приседаний', 'D:\Project\fitness\backend\src\main\resources\files\squatVideo.MOV', 'D:\Project\fitness\backend\src\main\resources\files\hands.jpg', 1);
INSERT INTO Exercise(name, muscle, description, video, image, trainer_id) VALUES ('классическое отжимание', 'большая грудная', 'Примите упор лежа на руках и ногах. Ноги должны быть вместе, а ваши ладони направьте вперед, так чтобы они были на ширине плеч. Затем необходимо выпрямить руки, при этом важно чтобы шея, спина и ноги были прямыми. Сгибайте руки в локтях, опускаясь к полу.', 'D:\Project\fitness\backend\src\main\resources\files\push-upsVideo.MOV', 'D:\Project\fitness\backend\src\main\resources\files\hands.jpg', 1);
